...
public isolated client class CarRentalServiceGetCartResponseCaller {
    private final grpc:Caller caller;
    ...
    isolated remote function sendGetCartResponse(GetCartResponse response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextGetCartResponse(ContextGetCartResponse response) returns grpc:Error? {
        return self.caller->send(response);
    }
